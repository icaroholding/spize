...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at **conduct@spize.io**. All complaints will be reviewed and investigated promptly and fairly.
...
1. **Correction** — private, written warning for a first offense
2. **Warning** — warning with consequences for continued behavior
3. **Temporary ban** — temporary ban from any sort of interaction
4. **Permanent ban** — permanent ban from public interaction
